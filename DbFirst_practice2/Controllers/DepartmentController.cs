...
namespace DbFirst_practice2.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DepartmentController : ControllerBase
    {
        private readonly DbFirstPracticeContext _context;

        public DepartmentController(DbFirstPracticeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(Department department)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'DbFirstPracticeContext.Departments'  is null.");
          }
