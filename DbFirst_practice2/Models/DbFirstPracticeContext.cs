...
{
    public partial class DbFirstPracticeContext : DbContext
    {
        public DbFirstPracticeContext()
        {
        }

        public DbFirstPracticeContext(DbContextOptions<DbFirstPracticeContext> options)
            : base(options)
        {
        }
