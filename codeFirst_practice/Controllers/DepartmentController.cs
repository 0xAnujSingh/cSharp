...
namespace codeFirst_practice.Controllers
{
    ...
    {
        private readonly CodeFirstPracticeContext _context;

        public DepartmentController(CodeFirstPracticeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(Department department)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'CodeFirstPracticeContext.Departments'  is null.");
          }
